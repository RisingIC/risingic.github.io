      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Achieving the global car accessories dream.`,
              description: `As a leader in high-end auto accessories production, Ersheng has 21 years of experience in the auto modification parts and has won numberous competitive awards and patents in R&D and production. We look forward to assisting you with our professionals auto parts experience and knowledge.`,
            }}
          />
